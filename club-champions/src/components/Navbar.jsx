    ...
    <div className='w-screen h-[80px] z-10 bg-zinc-200 fixed drop-shadow-lg'>
        <div className='px-2 flex justify-between items-center w-full h-full'>
            <div className='flex items-center'>
                ...
                <li><Link to="about" smooth={true} offset={-500} duration={500}>About</Link></li>
                <li><Link to="club" smooth={true} offset={-100} duration={500}>Club</Link></li>
                <li><Link to="description" smooth={true} offset={50} duration={500}>Description</Link></li>
